...
const specialItems = [
      {
        ...
        colors: ['YELLOW'],
        sizes: ['ONE SIZE'], 
        description:'/images/9357ee72-da7f-4e97-bef1-4c56bac62ed920250508.jpg'
      },
      {
        id:'special-2', 
        images:[
        ...
        <section className='special_wrap'>
            ...
            <div className='special_box'>
                <div className='special_top'>
                        <img src="/images/special_top.jpg" alt="Muse:hanee's collection Go shop" className='special-top-img' />
                </div>
